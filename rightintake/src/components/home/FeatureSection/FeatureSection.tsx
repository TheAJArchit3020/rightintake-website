            ...
            <div className={`${styles.features_section_wrapper}`}>
                ...
                <div className={`${styles.nutri_plans_wrapper}`}>
                    <div className={`${styles.nutri_plans_image}`}>
                        <img src="./images/homepage/FeatureSection/NutriPlansImg.png" alt="" />
                    </div>
                    <div className={`${styles.nutri_plans_message_wrapper}`}>
                        <div className={`${styles.nutri_plans_message_head} ${styles.message_head}`}>
                            <span>Explore Nutri-Plans</span>
                        </div>
                        <div className={`${styles.nutri_plans_message_para} ${styles.message_para}`}>
                            <span>
                ...
                <div className={`${styles.schedule_call_wrapper}`}>
                    <div className={`${styles.schedule_call_message}`}>
                        <div className={`${styles.schedule_call_message_head} ${styles.message_head}`}>
                            <span>Book a Call</span>
                        </div>
                        <div className={`${styles.schedule_call_message_para} ${styles.message_para}`}>
                            <span>
                    ...
                    <div className={`${styles.schedule_call_image}`}>
                        <img src="./images/homepage/FeatureSection/CallScheduling.png" alt="" />
                    </div>
                </div>
                <div className={`${styles.best_part_wrapper}`}>
                    <div className={`${styles.best_part_message}`}>
                        <div className={`${styles.best_part_message_head} ${styles.message_head}`}>
                            <span>Thats the Best Part!!</span>
                        </div>
                        <div className={`${styles.best_part_message_para} ${styles.message_para}`}>
                            <span>
                    ...
                    <div className={`${styles.best_part_image}`}>
                        <img src="./images/homepage/FeatureSection/bestPartBody.png" alt="" />
                    </div>
                </div>
                ...
                <div className={`${styles.tracking_wrapper}`}>
                    <div className={`${styles.tracking_message}`}>
                        <div className={`${styles.tracking_message_head} ${styles.message_head}`}>
                            <span>Track Your Calories Effortlessly!</span>
                        </div>
                        <div className={`${styles.tracking_message_para} ${styles.message_para}`}>
                            <span>
