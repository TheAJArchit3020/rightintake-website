    ...
    return (
        <div className={styles.forgotpassword_container}>
            ...
            <div className={styles.forgotpassword_wrapper}>
                    ...
                    <div className={styles.form_inputes}>
                        ...
                        <div className={styles.input_wrapper}>
                            ...
                            <span className={styles.pass_note}>
                                Password must contain 8 characters including 1 capital letter and 1 symbol.
                            </span>
                        </div>
                    ...
                    <div className={styles.form_inputes}>
                        ...
                        <div className={styles.input_wrapper}>
                            <input
                                ...
                                onChange={(e) => onChangeInputHandler("confirmpassword", e.target.value)}
                            />
                            <Image
                                src={showConfirmPassword ? "/images/deleteaccount/crossedeyes.svg" : "/images/deleteaccount/eyes.svg"}
                                alt="toggle visibility"
                                width={20}
                                height={20}
                ...
                <div className={styles.forgotpassword_button_container} onClick={ResetPasswordHandler}>
                    <button className={styles.forgotpassword_button}>Save Password</button>
                </div>
            </div>
        </div>
    );
