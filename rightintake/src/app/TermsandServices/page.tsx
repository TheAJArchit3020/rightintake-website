        ...
        <div className={`${styles.terms_container_wrapper}`}>
          ...
          <div className={`${styles.privacy_div}`}>
            ...
            >
              ...
              {isPrivacyToggle ? (
                <img
                  src="/images/termsandservices/minus.svg"
                  alt="plus"
                  width={20}
                />
              ) : (
                <img
                  src="/images/termsandservices/plus.svg"
                  alt="minus"
                  width={20}
                />
              )}
              ...
              <div className={`${styles.privacy_content_ui_wrapper}`}>
                <div className={`${styles.overview}`}>
                  ...
                  <p>
                    ...
                    apply to all users of the site and app, including without
                    ...
                    website or application. By accessing or using any part of
                    the site, app, or services, you agree to be bound by these
                    Terms of Service. If you do not agree to all the terms and
                    conditions of this agreement, then you may not access the
                    website, app, or use any services. If these Terms of Service
                    are considered an offer, acceptance is expressly limited to
                    these Terms of Service. Any new features or tools which are
                    added to the current website or app shall also be subject to
                    the Terms of Service. You can review the most current
                    ...
                    our website or app. It is your responsibility to check this
                    page periodically for changes. Your continued use of or
                    access to the website, app, or Service following the posting
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    province of residence or that you are the age of majority in
                    your state or province of residence and you have given us
                    your consent to allow any of your minor dependents to use
                    this site or app. You may not use our products or services
                    for any illegal or unauthorized purpose nor may you, in the
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    website or app through which the Service is provided,
                    without express written permission by us. The headings used
                    in this agreement are included for convenience only and will
                ...
                <div className={`${styles.content}`}>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    <li>
                      Daily calorie and food recommendations personalized to
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    <li>
                      ...
                      provided within the app (e.g., health details,
                      preferences) is accurate and up-to-date.
                    </li>
                    <li>
                ...
                <div className={`${styles.content}`}>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    ...
                    <li>
                      Refunds are not applicable once the plan has been
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    includes but is not limited to providing valid names,
                    billing addresses, payment methods, and contact details.
                  </p>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    ...
                    <li>
                      Cancel or modify orders that contain incorrect or
                      fraudulent information.
                    </li>
                    <li>
                      Suspend or terminate accounts that provide false or
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    The Kineticscape Studios website and the Right Intake App
                    may include links to third-party websites, platforms, or
                    resources that are not controlled or managed by us. These
                    links are provided solely for convenience or reference and
                    do not constitute endorsement or approval of the content,
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    We welcome user-generated comments, feedback, suggestions,
                    and other submissions related to our services. By submitting
                    such content, you grant Kineticscape Studios a
                    non-exclusive, perpetual, royalty-free, and transferable
                    license to use, reproduce, modify, publish, distribute, and
                    display your submissions across various media:
                  </p>
                  <ol className={`${styles.ordered_list}`}>
                    <li>
                    ...
                    <li>
                      ...
                      harmful, offensive, defamatory, infringing, or in
                      violation of any third-party rights will not be tolerated.
                      Submissions containing viruses or other malicious code are
                      strictly prohibited.
                    </li>
                    <li>
                ...
                <div className={`${styles.content}`}>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    ...
                    <li>
                      ...
                      service providers to facilitate transactions, improve user
                      experience, or provide customer support.
                    </li>
                    <li>
                      You are responsible for maintaining the security of your
                      account credentials. Kineticscape Studios is not liable
                      for unauthorized access resulting from negligence in
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    that compromise the integrity, security, or lawful use of
                    the Kineticscape Studios website, the Right Intake App, and
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    All services, tools, and information provided by
                    Kineticscape Studios, the Right Intake App, and the Right
                    Intake Diet and Workout Plan are offered on an "as is" and
                    "as available" basis. We make no guarantees regarding:
                  </p>
                  <ol className={`${styles.ordered_list}`}>
                    <li>
                    ...
                    <li>
                      The accuracy or reliability of the recommendations,
                      results, or content provided.
                    </li>
                  </ol>
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    This indemnity extends to all liabilities, damages, costs,
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    laws of India. Any legal proceedings related to these Terms
                    will be conducted under the jurisdiction of the courts
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    review the Terms of Service for updates. Continued use of
              ...
              <div className={`${styles.privacy_content_ui_wrapper}`}>
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    services, including the Right Intake App and Right Intake
                    Diet and Workout Plan, as part of the buying and selling
                    process, we collect personal information such as your name,
                    address, email address, and payment details. When you browse
                    our website or app, we automatically collect certain
                    information about your device, including your computer’s
                    internet protocol (IP) address, browser type, and operating
                    system, to help us provide a better user experience. Email
                    marketing (if applicable): With your permission, we may send
                    you emails about our services, products, promotions, and
                    updates. This includes notifications about new features or
                    changes to the Right Intake App and Right Intake Diet and
                    Workout Plan.
                  </p>
                </div>
                ...
                <div className={`${styles.content}`}>
                  <h1>04 PAYMENT</h1>
                  <p>
                    We use <b>Razorpay</b> for processing payments. Neither we
                    nor Razorpay store your card data on their servers. The data
                    is encrypted through the Payment Card Industry Data Security
                    Standard (PCI-DSS) during payment processing. Your
                    transaction data is only used as necessary to complete your
                    purchase and is deleted afterward.
                    <br />
                    <br />
                    Our payment gateway complies with PCI-DSS standards to
                    ensure the secure handling of credit card information. For
                    more details, please review Razorpay’s terms at
                    https://razorpay.com.
                  </p>
                </div>
                {/* content 5 */}
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    information we are required to provide for your
                    transactions. We encourage you to review their policies
                  </p>
                  <p>Jurisdictional Impact:</p>
                  <p>
                    If you engage in a transaction involving a third-party
                    service provider, your data may be subject to the laws of
                    the jurisdiction in which that provider or its facilities
                    are located.
                    <br />
                    <br />
                  ...
                  <p>
                    ...
                    external sites. We are not liable for the privacy practices
                    of these sites and encourage you to review their privacy
                    policies.
                  </p>
                </div>
                {/* content 6 */}
                <div className={`${styles.content}`}>
                  <h1>06 SECURITY</h1>
                  <p>
                    To protect your personal information, we use
                    industry-standard precautions to prevent unauthorized
                    access, misuse, or disclosure. Measures include encryption,
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    time. Changes will take effect immediately upon posting on
                    our website or app. Material changes will be highlighted,
                    ensuring you are informed about updates in how your
            ...
            {isRefundToggle && (
              <div className={`${styles.privacy_content_ui_wrapper}`}>
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    Refunds are generally not applicable for digital products
                    and services once they have been delivered or accessed.
                    However, exceptions may apply in specific cases, as
                    described below:
                  </p>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    <li>
                      ...
                      nature. Once the plan has been delivered, no refunds will
                      be issued.
                    </li>
                    <li>
                ...
                <div className={`${styles.content}`}>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    <li>
                      ...
                      purchased service, and our support team is unable to
                      resolve it within 7 business days, you may be eligible for
                      a refund.
                    </li>
                  </ol>
                  <p>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    <li>
                      ...
                      the duplicate charge will be refunded upon verification.
                    </li>
                  </ol>
                  <p>
                ...
                <div className={`${styles.content}`}>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    ...
                    <li>
                      A detailed explanation of the issue or reason for the
                      refund request.
                    </li>
                  </ol>
                  <p>
                    Refund requests must be submitted within 7 days of the
                    purchase date. Requests submitted after this period may not
                ...
                <div className={`${styles.content}`}>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    ...
                    <li>
                      <b>TRefund Timeframe:</b>Approved refunds will be
                      processed within 10 business days and will be credited to
                ...
                <div className={`${styles.content}`}>
                  ...
                  <ol className={`${styles.ordered_list}`}>
                    ...
                    <li>
                      If the service was used or accessed successfully without
                ...
                <div className={`${styles.content}`}>
                  ...
                  <p>
                    ...
                    Razorpay, are subject to their refund and processing
                    policies. While we will assist in resolving disputes, final
                    decisions regarding refunds for such transactions may rest
